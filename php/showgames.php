        ...
        <div class="container my-auto">
            <div class="table-responsive">
                ...
                <table class="table">  	
					...
					foreach($assessmentItems->xpath('assessmentItem') as $game){
						$irteera="<tr><td>".$game["bideojoko"]."</td>&nbsp";

						foreach($game->egileak->p as $egileak){
							$irteera .='<td>'. $egileak .'</td>&nbsp';
						}
						foreach($game->urtea->p as $urtea){
							$irteera .='<td>'. $urtea .'</td>&nbsp<br></tr>';
						}
						if ($irteera=="") {echo "Filmak ez du existitzen";}
						{echo $irteera;}
					}
					?>			
                </table>
